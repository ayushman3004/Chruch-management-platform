                ...
                <div className="flex gap-4 items-center">
                    {user ? (
                        <>
                            ...
                            {user.role === 'admin' ? (
                                <>
                                    ...
                                    <Link to="/profile" className="px-6 py-2.5 rounded-full font-medium transition-all duration-300 bg-gradient-to-r from-violet-600 to-indigo-600 text-white shadow-lg shadow-violet-600/25 hover:shadow-violet-600/40 hover:-translate-y-0.5">
                                        Profile
                                    </Link>
                                </>
                            ) : user.role === 'member' ? (
                        ...
                        <>
                            ...
                            <Link to="/register" className="px-6 py-2.5 rounded-full font-medium transition-all duration-300 bg-gradient-to-r from-violet-600 to-indigo-600 text-white shadow-lg shadow-violet-600/25 hover:shadow-violet-600/40 hover:-translate-y-0.5">
                                Get Started
                            </Link>
                        </>
                    )}
